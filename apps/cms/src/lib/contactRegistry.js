 ...
 * Marketplace contract, we look it up by address here. The CMS resolves the
 * BUYER's key (to encrypt a shipment-update / tracking code to) for the
 * seller→buyer reply path.
 *
 * ─────────────────────────────────────────────────────────────────────────────
